  ...
  async function voteProposal(e) {
    ...
    await wallet
      .callMethod({
        ...
        method: "vote_for",
        args: {
          id: parseInt(proposalId.value),
          voto: parseInt(proposalVote.value),
        },
      })
      .then(async () => {
        return getProposal();
  ...
  async function endProposal(e) {
    ...
    let v = await wallet
      .callMethod({
        contractId: contractId,
        method: "set_winner",
        args: { id: parseInt(proposalInput.value) },
      })
      .then(async () => {
        return getProposal();
      })
    ...
    <>
      <main className={uiPleaseWait ? "please-wait" : ""}>
        ...
        <form onSubmit={voteProposal} className="formularioBonito">
          <label>
            You have to enter the number of the proposal, a 1 for approving or a
            2 for denying
          </label>
          <div>
